...
require (
	...
	github.com/smartcontractkit/chainlink-llo v0.0.0-20231115154526-abefc17cc332
	github.com/smartcontractkit/chainlink-relay v0.1.7-0.20231115153227-c2e71a404d2f
